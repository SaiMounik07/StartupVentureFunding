...
<div class="container">
  ...
  <div class="card">
    ...
    <form action="investl.php" method="post">
  ...
  <div class="card alt">
    ...
    <h1 class="title">Investor Register
      <div class="close"></div>
    </h1>
    <form action="investr.php" method="post">
      <div class="input-container">
        <input type="#{type}" id="#{label}" name="uname" required="required"/>
        <label for="#{label}">Username</label>
        <div class="bar"></div>
      ...
      <div class="input-container">
        <input type="password" id="#{label}" name="rpass" required="required"/>
